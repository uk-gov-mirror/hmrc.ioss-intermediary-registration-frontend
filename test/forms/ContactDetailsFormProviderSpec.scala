...
class ContactDetailsFormProviderSpec extends StringFieldBehaviours {
  ...
  ".telephoneNumber" - {
    ...
    val requiredKey = "contactDetails.error.telephoneNumber.required"
    val lengthKey = "contactDetails.error.telephoneNumber.length"
    val invalidKey = "contactDetails.error.telephoneNumber.invalid"
    val maxLength = 20
  ...
  ".emailAddress" - {
    ...
    val requiredKey = "contactDetails.error.emailAddress.required"
    val lengthKey = "contactDetails.error.emailAddress.length"
    val invalidKey = "contactDetails.error.emailAddress.invalid"
